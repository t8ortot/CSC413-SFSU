...
public class Lexer {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            while (true) {
                ...
                tok = lex.nextToken();
                System.out.printf("%-13s %-15s %-15s %s", tok.toString(), "Left: " + tok.getLeftPosition(), "Right: " + tok.getRightPosition(), "Line: " + tok.getLine() + "\n");
    ...
    public Token newIdToken(String id, int startPosition, int endPosition) {
        return new Token(startPosition, endPosition, Symbol.symbol(id, Tokens.Identifier), this.source.getLineno());
    }
    ...
    public Token newNumberToken(String number, int startPosition, int endPosition) {
        return new Token(
                ...
                Symbol.symbol(number, Tokens.INTeger), this.source.getLineno()
        );
    }
    ...
    public Token makeToken(String s, int startPosition, int endPosition) {
        ...
        return new Token(startPosition, endPosition, sym, this.source.getLineno());
    }
